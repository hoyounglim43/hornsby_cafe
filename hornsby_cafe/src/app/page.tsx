          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="p-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="italic mb-4">"The atmosphere at Café Forest is unmatched. It's my go-to spot for both work and relaxation. The Forest Blend Latte is absolutely divine!"</p>
            ...
            <Card className="p-6">
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 bg-green-100 rounded-full mb-4"></div>
                <p className="italic mb-4">"As someone who appreciates quality coffee, I can say with confidence that Café Forest serves some of the best in town. Their commitment to sustainability is also admirable."</p>
            ...
            <Card className="p-6">
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 bg-green-100 rounded-full mb-4"></div>
                <p className="italic mb-4">"The Woodland Berry Tart paired with their signature coffee is a match made in heaven. The staff is always friendly and the ambiance is perfect."</p>
